...
export const HistoryView: React.FC = () => {
  ...
  const [activeTab, setActiveTab] = useState<'waste' | 'points' | 'redeem' | 'guest'>('waste');
              ...
              return (
                ...
                >
                  ...
                  <div className="flex sm:flex-col items-end justify-between w-full sm:w-auto pt-2 sm:pt-0 border-t sm:border-t-0 border-slate-50 gap-1.5">
                    <div className="flex items-center gap-1 text-emerald-800 bg-emerald-50 px-2.5 py-0.5 rounded-lg font-bold text-xs">
                      <Coins className="w-3 h-3 text-amber-500 fill-amber-400" />
                      <span>+{record.points_awarded} แต้ม</span>
                    </div>
